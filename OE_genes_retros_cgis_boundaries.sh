...
# CTCF boundaries, merged replicates with bedtools intersect

./sigoverlap -v -s 2881033286 -t Ziller-2013-Human_HepG2.boundaries HepG2_CTCF_Ht_intersection_autosomes.bed

./sigoverlap -v -s 2881033286 -t
